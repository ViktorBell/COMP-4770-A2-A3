...
namespace A2
{
    ...
    public class Microbe : TransformAgent
    {
        ...
        /// <summary>
        /// How much time has passed since this microbe had it's last target.
        /// </summary>
        public float timeElapsedSinceLastTarget { get; private set; }
        ...
        /// Increase the age of the microbe.
        /// </summary>
        public void TrackTimeBetweenTargets()
        {
            timeElapsedSinceLastTarget += Time.deltaTime;
        }
