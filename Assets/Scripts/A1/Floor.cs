...
namespace A1
{
    ...
    public class Floor : MonoBehaviour
    {
        ...
        //An updated clean method that makes a floor tile 'squeaky clean' (Clean + LikelyToGetDirty) because the worm hole sucks up literally every molecule of dirt from the area when cleaning
        public void WormHoleClean() 
        {
            State = DirtLevel.Clean;
            this.LikelyToGetDirty = true;
            UpdateMaterial();
